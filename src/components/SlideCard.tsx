...
import { Slide, useDeckStore } from '@/store/deck-store';
import { Trash2, Copy, Eye, PenLine, Download, ClipboardCopy, Link2 } from 'lucide-react';
...
export function SlideCard({ slide, index }: SlideCardProps) {
    const { updateSlide, removeSlide, duplicateSlide, globalTheme, setSlides, setSourceText } = useDeckStore();
