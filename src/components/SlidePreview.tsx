...
export function SlidePreview({ content }: { content: string; theme?: string }) {
  ...
  return (
    <div className="w-full border border-red-600 h-full max-h-screen flex justify-center bg-gray-100 dark:bg-gray-900/50 p-4 rounded-lg">
      <div
        style={{
        ...
        className={clsx(
          "w-full max-w-125 max-h-screen flex items-center justify-center p-8 md:p-12 relative transition-all duration-300",
